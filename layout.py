...
layout = html.Div([
    ...
    html.Div([
        ...
        dcc.RadioItems(
            id='drawing-style',
            options=[{'label': 'Straght line', 'value': 'drawline'},
...
#        ),
    ...
    html.Div([
        ...
        html.Div(html.Button('Load', id='load-trace', n_clicks=0),
        style={'width': '60%','display': 'inline-block'}
        )
